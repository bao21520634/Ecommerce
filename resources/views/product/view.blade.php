    ...
    <div x-data="productItem({{ json_encode([
        ...
        <div class="grid gap-6 grid-cols-1 lg:grid-cols-5">
                 ...
                 $product->images->map(fn($im) => $im->url) : json_encode(['/img/noimage.png'])}},
                    ...
                    <div class="relative">
                        <template x-for="image in images">
                            <div x-show="activeImage === image" class="w-full h-[240px] sm:h-[400px] flex items-center justify-center">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="text-xl font-bold mb-6">{{number_format($product->price)}}đ</div>
                ...
                <div class="flex items-center justify-between mb-5">
                    ...
                    <input type="number" name="quantity" x-ref="quantityEl" value="1" min="1" oninput="this.value = Math.abs(this.value) >= 1 ? Math.abs(this.value) : null" onblur="this.value = this.value || 1" class="w-32 focus:border-blue-500 focus:outline-none rounded" />
                </div>
                <button :disabled="product.quantity === 0" @click="addToCart($refs.quantityEl.value)" class="btn-primary py-4 text-lg flex justify-center min-w-0 w-full mb-6" :class="product.quantity === 0 ? 'cursor-not-allowed' : 'cursor-pointer'">
