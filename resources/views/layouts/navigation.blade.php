<header x-data="{
    ...
    }" @cart-change.window="cartItemsCount = $event.detail.count" style="background-color: black;" class="flex justify-between text-white">
    <div>
    ...
    <nav class="hidden md:block">
        <ul class="grid grid-flow-col items-center">
            ...
            <li x-data="{open: false}" class="relative">
                ...
                <ul @click.outside="open = false" x-show="open" x-transition x-cloak class="absolute z-10 right-0 py-2" style="background-color: #161617; width: 200px; border-bottom-left-radius: 4px; border-bottom-right-radius: 4px;">
                    <li>
            ...
            @else
            <li>
                <a href="{{ route('register') }}" class="flex items-center py-navbar-item ml-2 px-navbar-item hover:bg-slate-900">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                    </svg>
                    Register
            ...
            <li>
                <a href="{{ route('login') }}" class="inline-flex items-center text-white bg-emerald-600 py-2 px-6 mx-5 rounded shadow-md hover:bg-emerald-700 active:bg-emerald-800 transition-colors">
                    Login 
                </a>
            </li>
            @endif
